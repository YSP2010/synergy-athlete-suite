...
export const messages: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "focus.presetLabel": "Vorlage",
    "focus.custom": "Feinauswahl",
    "focus.warning":
      "Wenn du {region} ganz rausnimmst, fehlt deinem Plan womöglich Stabilität und Balance.",
    "focus.revert": "Rückgängig",
    "focus.keep": "Trotzdem so lassen",
    "focus.level.off": "Aus",
    "focus.level.less": "Weniger",
    "focus.level.normal": "Standard",
    "focus.level.focus": "Betonen",
    "focus.region.chest": "Brust",
    "focus.region.back": "Rücken",
    "focus.region.shoulders": "Schultern",
    "focus.region.arms": "Arme",
    "focus.region.core": "Core/Bauch",
    "focus.region.legs": "Beine",
    "focus.group.chest_upper": "Obere Brust",
    "focus.group.chest_lower": "Untere/mittlere Brust",
    "focus.group.back_lats": "Latissimus (Breite)",
    "focus.group.back_upper": "Oberer Rücken/Trapez",
    "focus.group.back_lower": "Unterer Rücken",
    "focus.group.delts_front": "Vordere Schulter",
    "focus.group.delts_side": "Seitliche Schulter",
    "focus.group.delts_rear": "Hintere Schulter",
    "focus.group.biceps": "Bizeps",
    "focus.group.triceps": "Trizeps",
    "focus.group.forearms": "Unterarme",
    "focus.group.abs": "Gerade Bauchmuskeln",
    "focus.group.obliques": "Seitliche Bauchmuskeln",
    "focus.group.glutes": "Gesäß",
    "focus.group.quads": "Quadrizeps",
    "focus.group.hamstrings": "Beinbeuger",
    "focus.group.calves": "Waden",
    "focus.preset.balanced": "Ausgewogen",
    "focus.preset.hourglass": "Gesäß & Schultern",
    "focus.preset.upper": "Oberkörper-Fokus",
    "focus.preset.lower": "Unterkörper-Fokus",
    "focus.preset.push": "Push-Fokus",
    "focus.preset.pull": "Pull-Fokus",
    "focus.preset.custom": "Eigene Auswahl",
  ...
  en: {
    ...
    "focus.custom": "Fine-tune",
    "focus.warning": "If you remove {region} entirely, your plan may lack stability and balance.",
    "focus.revert": "Undo",
    "focus.keep": "Keep anyway",
    "focus.level.off": "Off",
    "focus.level.less": "Less",
    "focus.level.normal": "Standard",
    "focus.level.focus": "Emphasise",
    "focus.region.chest": "Chest",
    "focus.region.back": "Back",
    "focus.region.shoulders": "Shoulders",
    "focus.region.arms": "Arms",
    "focus.region.core": "Core/Abs",
    "focus.region.legs": "Legs",
    "focus.group.chest_upper": "Upper chest",
    "focus.group.chest_lower": "Mid/lower chest",
    "focus.group.back_lats": "Lats (width)",
    "focus.group.back_upper": "Upper back/traps",
    "focus.group.back_lower": "Lower back",
    "focus.group.delts_front": "Front delts",
    "focus.group.delts_side": "Side delts",
    "focus.group.delts_rear": "Rear delts",
    "focus.group.biceps": "Biceps",
    "focus.group.triceps": "Triceps",
    "focus.group.forearms": "Forearms",
    "focus.group.abs": "Abs",
    "focus.group.obliques": "Obliques",
    "focus.group.glutes": "Glutes",
    "focus.group.quads": "Quads",
    "focus.group.hamstrings": "Hamstrings",
    "focus.group.calves": "Calves",
    "focus.preset.balanced": "Balanced",
    "focus.preset.hourglass": "Glutes & Shoulders",
    "focus.preset.upper": "Upper-body focus",
    "focus.preset.lower": "Lower-body focus",
    "focus.preset.push": "Push focus",
    "focus.preset.pull": "Pull focus",
  ...
  uk: {
    ...
    "focus.presetLabel": "Шаблон",
    "focus.custom": "Точне налаштування",
    "focus.warning":
      "Якщо повністю прибрати {region}, плану може бракувати стабільності та балансу.",
    "focus.revert": "Скасувати",
    "focus.keep": "Все одно залишити",
    "focus.level.off": "Вимк.",
    "focus.level.less": "Менше",
    "focus.level.normal": "Стандарт",
    "focus.level.focus": "Акцент",
    "focus.region.chest": "Груди",
    "focus.region.back": "Спина",
    "focus.region.shoulders": "Плечі",
    "focus.region.arms": "Руки",
    "focus.region.core": "Кор/Прес",
    "focus.region.legs": "Ноги",
    "focus.group.chest_upper": "Верх грудей",
    "focus.group.chest_lower": "Середина/низ грудей",
    "focus.group.back_lats": "Широчайші (ширина)",
    "focus.group.back_upper": "Верх спини/трапеції",
    "focus.group.back_lower": "Низ спини",
    "focus.group.delts_front": "Передні дельти",
    "focus.group.delts_side": "Середні дельти",
    "focus.group.delts_rear": "Задні дельти",
    "focus.group.biceps": "Біцепс",
    "focus.group.triceps": "Трицепс",
    "focus.group.forearms": "Передпліччя",
    "focus.group.abs": "Прес",
    "focus.group.obliques": "Косі м’язи",
    "focus.group.glutes": "Сідниці",
    "focus.group.quads": "Квадрицепс",
    "focus.group.hamstrings": "Біцепс стегна",
    "focus.group.calves": "Литки",
    "focus.preset.balanced": "Збалансовано",
    "focus.preset.hourglass": "Сідниці й плечі",
    "focus.preset.upper": "Фокус на верх",
    "focus.preset.lower": "Фокус на низ",
    "focus.preset.push": "Push-фокус",
    "focus.preset.pull": "Pull-фокус",
    "focus.preset.custom": "Власний вибір",
